...
Usage:
    ...
    $ python 20201027_lgb_train.py | Tee-Object -FilePath ./20201027_lgb_train/train.log
    $ python 20201027_lgb_train.py -m objective | Tee-Object -FilePath ./20201027_lgb_train/objective.log

    $ python 20201027_lgb_train.py -d  # デバッグ
    $ python 20201027_lgb_train.py -m objective  # パラメータチューニング
"""
import datetime
import logging
import os
