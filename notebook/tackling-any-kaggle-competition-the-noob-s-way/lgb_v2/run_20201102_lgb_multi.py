...
Usage:
    ...
    $ python run_20201102_lgb_multi.py -p chain_non | Tee-Object -FilePath ./run_20201102_lgb_multi/train.log
    $ python run_20201102_lgb_multi.py -m objective -p chain_non | Tee-Object -FilePath ./run_20201102_lgb_multi/objective.log

    $ poetry run python run_20201102_lgb_multi.py -p chain -is_o_non 2>&1

    $ python run_20201102_lgb_multi.py -p multi # MultiOutputClassifierモデル作成
    $ python run_20201102_lgb_multi.py -p chain  # ClassifierChainモデル作成
    $ python run_20201102_lgb_multi.py -p chain_non  # nonscored + ClassifierChainモデル作成
    $ python run_20201102_lgb_multi.py -d -p multi # デバッグ
    $ python run_20201102_lgb_multi.py -m objective -p multi # パラメータチューニング
"""
import os
import sys
import glob
...
if args["PRAMS_NAME"] == "multi":
    ...
    OUTDIR = "run_20201102_lgb_multi/multi"
    ...
    IS_ORDER_NONSCORED = False
    OUTDIR = "run_20201102_lgb_multi/chain"
    ...
    OUTDIR = "run_20201102_lgb_multi/chain_nonscored"
